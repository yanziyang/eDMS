      ...
      {!sent ? (
        <div>
          ...
          <p className="mb-6 text-sm text-muted-foreground">
            Enter the email address associated with your account and we'll send a link to reset your
            password.
          </p>
          <form
            onSubmit={(e) => {
        ...
        <div>
          ...
          <p className="mb-6 text-sm text-muted-foreground">
            If an account exists for <strong>{email.trim() || "your email address"}</strong>, a password
          ...
          <Button
            ...
            className="w-full"
            onClick={() =>
              toast.success("Reset link resent", { description: email.trim() || "your email address" })
            }
          >
            Resend email
          </Button>
