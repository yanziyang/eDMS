        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    filter_config = table.Column<string>(type: "varchar(16384)", maxLength: 16384, nullable: false),
                    sort_config = table.Column<string>(type: "varchar(16384)", maxLength: 16384, nullable: false),
                    group_by_column = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
