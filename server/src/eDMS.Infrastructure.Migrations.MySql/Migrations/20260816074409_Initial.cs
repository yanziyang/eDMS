        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    auth_provider = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    external_id = table.Column<string>(type: "varchar(512)", maxLength: 512, nullable: true),
                    avatar_url = table.Column<string>(type: "varchar(2048)", maxLength: 2048, nullable: true),
                    is_system_admin = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    must_change_password = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValue: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    principal_type = table.Column<int>(type: "int", nullable: false),
                    principal_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    level = table.Column<int>(type: "int", nullable: false),
                    granted_by = table.Column<Guid>(type: "char(36)", nullable: false),
                    granted_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    url_slug = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "char(36)", nullable: false),
                    timestamp = table.Column<DateTimeOffset>(type: "datetime", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP(6)"),
                    user_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    action = table.Column<int>(type: "int", nullable: false),
                    object_type = table.Column<int>(type: "int", nullable: false),
                    object_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    object_name = table.Column<string>(type: "longtext", nullable: false),
                    site_id = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false),
                    description = table.Column<string>(type: "varchar(1024)", maxLength: 1024, nullable: true),
                    enable_versioning = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    enable_minor_versions = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    require_checkout = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_by = table.Column<Guid>(type: "char(36)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    deleted_at = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    added_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "char(36)", nullable: false),
                    library_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    parent_folder_id = table.Column<Guid>(type: "char(36)", nullable: true),
                    name = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: false),
                    path = table.Column<string>(type: "longtext", nullable: false),
                    modified_by = table.Column<Guid>(type: "char(36)", nullable: true),
                    modified_at = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
                    created_by = table.Column<Guid>(type: "char(36)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false),
                    is_deleted = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    deleted_at = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "char(36)", nullable: false),
                    library_id = table.Column<Guid>(type: "char(36)", nullable: false),
                    folder_id = table.Column<Guid>(type: "char(36)", nullable: true),
                    ...
                    current_version_id = table.Column<Guid>(type: "char(36)", nullable: true),
                    checked_out_by = table.Column<Guid>(type: "char(36)", nullable: true),
                    checked_out_at = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
                    modified_by = table.Column<Guid>(type: "char(36)", nullable: true),
                    modified_at = table.Column<DateTimeOffset>(type: "datetime", nullable: true),
                    created_by = table.Column<Guid>(type: "char(36)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    document_id = table.Column<Guid>(type: "char(36)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_major = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    created_by = table.Column<Guid>(type: "char(36)", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "datetime", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "ix_item_permissions_object_type_object_id_principal_type_princi",
                table: "item_permissions",
